...
for preIdx_index = 1:length(UE_preIdxs)
    ...
    prachConfig.PrachConfigurationIndex = 45;
    prachConfig.RootSequenceIndex = 0;
    ...
    carrierConfig.SubcarrierSpacing = 15;
    ...
    %% Scale signal
    signalOut_TDL_whithoutNoise = signalScale(signalOut_TDL_whithoutNoise);
