function [zadoffChuSeq_slot, preambleIndex_timeAdvance_arr] = PRACH_demodulation(prachConfig, carrierConfig, PrachConfigFR1UnpairedSpectrum, timeDomain_signal)
