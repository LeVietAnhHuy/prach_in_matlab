function [zadoffChuSeq_slot, preambleIndex_timeAdvance_arr, array_ifft_corr_fft, ifftSeq_array, mean_u_ifft, pos, C_v_arr] = PRACH_demodulation_6(prachConfig, carrierConfig, PrachConfigFR1UnpairedSpectrum, timeDomain_signal)
