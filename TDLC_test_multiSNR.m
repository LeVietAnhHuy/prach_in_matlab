...
for snr = snr_range
    ...
    for test_id = 1:num_test
        ...
        [zadoffChuSeq_slot, output, corr_iffft, ifftSeq_array, mean_u_ifft, C_v_arr, detected_preambleIndex_arr, nTA_microSecond_arr] = frequencyCombining_PRACH_demodulation_plot1(prachConfig, carrierConfig, PrachConfigFR1UnpairedSpectrum, constant, timeErrorTolerance, timeDomain_signal_AWGN_TDL, isPlot, isPrintResult);
